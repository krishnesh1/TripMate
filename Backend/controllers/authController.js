        ...
        html: `
          <div style="font-family: Arial; padding:20px;">
            ...
            <p style="font-size:12px; color:gray;">
              &copy; ${new Date().getFullYear()} TripMate
            </p>
          </div>
        `,
      });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; background:#f9fafb;">
          <div style="max-width: 500px; margin: auto; background: white; padding: 30px; border-radius: 10px;">
            <h2 style="color:#10b981; text-align:center;">TripMate Password Reset</h2>
            <p>Hello ${user.name || ""},</p>
            <p>You requested to reset your password.</p>
            <p>Your One-Time Password (OTP) is:</p>
            <div style="text-align:center; margin:20px 0;">
              <span style="font-size:28px; letter-spacing:4px; font-weight:bold; background:#ecfdf5; padding:12px 20px; border-radius:8px; display:inline-block; color:#065f46;">
                ${otp}
              </span>
            </div>
